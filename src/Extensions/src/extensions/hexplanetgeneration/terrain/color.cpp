...
Color::Color(float maxHeight) : _maxHeight{maxHeight}, _parchmentFactor{0.f}
{
  setupGradient();
}
...
{
  _terrainGradient = std::make_unique<Gradient<Color3>>(_maxHeight + 1.f);
  ...
  // Coastal Water
  _terrainGradient->addStop(
    0.49f, Color3(153.f / 255.f, 204.f / 255.f, 255.f / 255.f));

  // Coastal Land
  _terrainGradient->addStop(
    0.5f, Color3(255.f / 255.f, 255.f / 255.f, 204.f / 255.f));
  ...
  // Mountain Peaks
  _terrainGradient->addStop(
    0.72f, Color3(230.f / 255.f, 255.f / 255.f, 255.f / 255.f));

  // Mountain Peaks
  _terrainGradient->addStop(
    1.f, Color3(230.f / 255.f, 255.f / 255.f, 255.f / 255.f));

  _terrainGradient->calculate();

  _terrainGradient2D = std::make_unique<ColorGradient2D>(256);
...
Color3 Color::getColor(float heightNorm, float rainNorm, float tempNorm)
{
  ...
  auto color2D = _terrainGradient2D->getColor(1.f - tempNorm,
                                              1.f - (rainNorm * invHeight));
