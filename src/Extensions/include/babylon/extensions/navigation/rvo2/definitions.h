...
#ifndef BABYLON_EXTENSIONS_NAVIGATION_RVO2_DEFINITIONS_H
#define BABYLON_EXTENSIONS_NAVIGATION_RVO2_DEFINITIONS_H
...
#endif /* BABYLON_EXTENSIONS_NAVIGATION_RVO2_DEFINITIONS_H */
