...
#ifndef BABYLON_EXTENSIONS_NAVIGATION_RVO2_RVO_H
#define BABYLON_EXTENSIONS_NAVIGATION_RVO2_RVO_H
...
/**
 ...
 Avoidance</a>
 (ORCA) formulation for multi-agent simulation. <b>RVO2 Library</b>
 automatically
 uses parallelism for computing the motion of the agents if your machine has
 multiple processors and your compiler supports <a
 ...
 dances. Furthermore, ORCA provides stronger guarantees with respect to
 collision
 avoidance.
 ...
 principle
 be accompanied by global path planning that determines the preferred velocity
 of
 ...
 of
 the agents. As a consequence of this change, <b>RVO2 Library</b> does not have
 a
 ...
 though. Lastly, in %RVO Library 1.x an instance of the simulator is a
 singleton.
 ...
 the
 method setPreferredVelocities(...). The simulator computes the actual
 velocities
 ...
 instance to visualize the simulation. In the above example program, this is
 done
 ...
 agents
 can be changed ahead of each simulation step. In the above example program,
 this
 ...
 found in the
 <tt>$RVO_ROOT/examples</tt> directory. The examples are named Blocks, Circle,
 and
...
#endif /* BABYLON_EXTENSIONS_NAVIGATION_RVO2_RVO_H */
