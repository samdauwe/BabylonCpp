...
#ifndef BABYLON_EXTENSIONS_NAVIGATION_RVO2_KD_TREE_H
#define BABYLON_EXTENSIONS_NAVIGATION_RVO2_KD_TREE_H
...
#endif /* BABYLON_EXTENSIONS_NAVIGATION_RVO2_KD_TREE_H */
