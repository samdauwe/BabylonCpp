...
#ifndef BABYLON_EXTENSIONS_NAVIGATION_RVO2_RVO_SIMULATOR_H
#define BABYLON_EXTENSIONS_NAVIGATION_RVO2_RVO_SIMULATOR_H
...
}; // end of class RVOSimulator

} // end of namespace RVO2
} // end of namespace Extensions
} // end of namespace BABYLON

#endif /* BABYLON_EXTENSIONS_NAVIGATION_RVO2_RVO_SIMULATOR_H */
