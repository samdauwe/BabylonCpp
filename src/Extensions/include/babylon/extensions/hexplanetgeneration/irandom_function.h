#ifndef BABYLON_EXTENSIONS_HEX_PLANET_GENERATION_IRANDOM_FUNCTION_H
#define BABYLON_EXTENSIONS_HEX_PLANET_GENERATION_IRANDOM_FUNCTION_H
...
#endif // end of
       // BABYLON_EXTENSIONS_HEX_PLANET_GENERATION_IRANDOM_FUNCTION_H
