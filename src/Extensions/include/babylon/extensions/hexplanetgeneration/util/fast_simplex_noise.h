#ifndef BABYLON_EXTENSIONS_HEX_PLANET_GENERATION_UTIL_SIMPLEX_NOISE_H
#define BABYLON_EXTENSIONS_HEX_PLANET_GENERATION_UTIL_SIMPLEX_NOISE_H
...
#endif // end of BABYLON_EXTENSIONS_HEX_PLANET_GENERATION_UTIL_SIMPLEX_NOISE_H
