#ifndef BABYLON_MATERIALS_LIBRARY_NORMAL_NOMAL_MATERIAL_DEFINES_H
#define BABYLON_MATERIALS_LIBRARY_NORMAL_NOMAL_MATERIAL_DEFINES_H
...
struct BABYLON_SHARED_EXPORT NormalMaterialDefines : public MaterialDefines {
  ...
  static constexpr unsigned int SHADOWVSM0   = 30;
  static constexpr unsigned int SHADOWVSM1   = 31;
  static constexpr unsigned int SHADOWVSM2   = 32;
  static constexpr unsigned int SHADOWVSM3   = 33;
...
#endif // end of BABYLON_MATERIALS_LIBRARY_NORMAL_NOMAL_MATERIAL_DEFINES_H
