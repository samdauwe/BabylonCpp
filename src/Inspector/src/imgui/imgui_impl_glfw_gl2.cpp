...
//  glfwSetCursor()). 2018-02-20: Inputs: Renamed GLFW callbacks exposed in .h
//  to not include GL2 in their name. 2018-02-16: Misc: Obsoleted the
//  io.RenderDrawListsFn callback and exposed ImGui_ImplGlfwGL2_RenderDrawData()
//  in the .h file so you can call it yourself. 2018-02-06: Misc: Removed call
//  to ImGui::Shutdown() which is not available from 1.60 WIP, user needs to
//  call CreateContext/DestroyContext themselves. 2018-02-06: Inputs: Added
//  mapping for ImGuiKey_Space. 2018-02-06: Inputs: Honoring the
...
//  ImGuiKey_Insert. 2018-01-09: Misc: Renamed imgui_impl_glfw.* to
//  imgui_impl_glfw_gl2.*. 2017-09-01: OpenGL: Save and restore current polygon
//  mode. 2017-08-25: Inputs: MousePos set to -FLT_MAX,-FLT_MAX when mouse is
//  unavailable/missing (instead of -1,-1). 2016-10-15: Misc: Added a void*
//  user_data parameter to Clipboard function handlers. 2016-09-10: OpenGL:
//  Uploading font texture as RGBA32 to increase compatibility with users
...
static void ImGui_ImplGlfwGL2_SetClipboardText(void* user_data,
                                               const char* text)
{
