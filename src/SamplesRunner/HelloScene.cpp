...
namespace SamplesRunner {
  HelloScene::HelloScene(BABYLON::ICanvas* iCanvas) : IRenderableScene(iCanvas)
  {
  }
  ...
  const char* HelloScene::getName()
  {
    return "Hello Scene";
  }

  void HelloScene::initializeScene(BABYLON::ICanvas* canvas, BABYLON::Scene* scene)
  {
...
} // end of namespace SamplesRunner
