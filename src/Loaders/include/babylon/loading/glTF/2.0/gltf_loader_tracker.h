#ifndef BABYLON_LOADING_GLTF_2_0_GLTF_LOADER_TRACKER_H
#define BABYLON_LOADING_GLTF_2_0_GLTF_LOADER_TRACKER_H
...
#endif // end of BABYLON_LOADING_GLTF_2_0_GLTF_LOADER_TRACKER_H
