#ifndef BABYLON_PROCEDURAL_TEXTURES_LIBRARY_CLOUD_PROCEDURAL_TEXTURE_H
#define BABYLON_PROCEDURAL_TEXTURES_LIBRARY_CLOUD_PROCEDURAL_TEXTURE_H
...
#endif // end of
       // BABYLON_PROCEDURAL_TEXTURES_LIBRARY_CLOUD_PROCEDURAL_TEXTURE_H
