...
TEST(TestVertexData, CreateSphere)
{
  ...
  // Set expected results
  Uint32Array expectedIndices{
    0,  1,  7,  7,  1,  8,  1,  2,  8,  8,  2,  9,   //
    2,  3,  9,  9,  3,  10, 3,  4,  10, 10, 4,  11,  //
    4,  5,  11, 11, 5,  12, 5,  6,  12, 12, 6,  13,  //
    7,  8,  14, 14, 8,  15, 8,  9,  15, 15, 9,  16,  //
    9,  10, 16, 16, 10, 17, 10, 11, 17, 17, 11, 18,  //
    11, 12, 18, 18, 12, 19, 12, 13, 19, 19, 13, 20,  //
    14, 15, 21, 21, 15, 22, 15, 16, 22, 22, 16, 23,  //
    16, 17, 23, 23, 17, 24, 17, 18, 24, 24, 18, 25,  //
    18, 19, 25, 25, 19, 26, 19, 20, 26, 26, 20, 27}; //
  Float32Array expectedPositions{
    0.000000f,  0.005000f,  0.000000f,  0.000000f,  0.005000f,  0.000000f,  //
    0.000000f,  0.005000f,  0.000000f,  0.000000f,  0.005000f,  0.000000f,  //
    0.000000f,  0.005000f,  0.000000f,  0.000000f,  0.005000f,  0.000000f,  //
    0.000000f,  0.005000f,  0.000000f,  0.004330f,  0.002500f,  0.000000f,  //
    0.002165f,  0.002500f,  -0.003750f, -0.002165f, 0.002500f,  -0.003750f, //
    -0.004330f, 0.002500f,  -0.000000f, -0.002165f, 0.002500f,  0.003750f,  //
    0.002165f,  0.002500f,  0.003750f,  0.004330f,  0.002500f,  0.000000f,  //
    0.004330f,  -0.002500f, 0.000000f,  0.002165f,  -0.002500f, -0.003750f, //
    -0.002165f, -0.002500f, -0.003750f, -0.004330f, -0.002500f, -0.000000f, //
    -0.002165f, -0.002500f, 0.003750f,  0.002165f,  -0.002500f, 0.003750f,  //
    0.004330f,  -0.002500f, 0.000000f,  0.000000f,  -0.005000f, 0.000000f,  //
    0.000000f,  -0.005000f, -0.000000f, -0.000000f, -0.005000f, -0.000000f, //
    -0.000000f, -0.005000f, -0.000000f, -0.000000f, -0.005000f, 0.000000f,  //
    0.000000f,  -0.005000f, 0.000000f,  0.000000f,  -0.005000f, 0.000000f}; //
  Float32Array expectedNormals{
    ...
    0.000000f,  1.000000f,  0.000000f,  0.000000f,  1.000000f,  0.000000f,  //
    0.000000f,  1.000000f,  0.000000f,  0.000000f,  1.000000f,  0.000000f,  //
    0.000000f,  1.000000f,  0.000000f,  0.866025f,  0.500000f,  0.000000f,  //
    0.433013f,  0.500000f,  -0.750000f, -0.433013f, 0.500000f,  -0.750000f, //
    -0.866025f, 0.500000f,  -0.000000f, -0.433013f, 0.500000f,  0.750000f,  //
    0.433013f,  0.500000f,  0.750000f,  0.866025f,  0.500000f,  0.000000f,  //
    0.866025f,  -0.500000f, 0.000000f,  0.433013f,  -0.500000f, -0.750000f, //
    -0.433013f, -0.500000f, -0.750000f, -0.866025f, -0.500000f, -0.000000f, //
    -0.433013f, -0.500000f, 0.750000f,  0.433013f,  -0.500000f, 0.750000f,  //
  ...
  Float32Array expectedUVs{
    0.000000f, 0.000000f, 0.166667f, 0.000000f, 0.333333f, 0.000000f, //
    0.500000f, 0.000000f, 0.666667f, 0.000000f, 0.833333f, 0.000000f, //
    1.000000f, 0.000000f, 0.000000f, 0.333333f, 0.166667f, 0.333333f, //
    0.333333f, 0.333333f, 0.500000f, 0.333333f, 0.666667f, 0.333333f, //
    0.833333f, 0.333333f, 1.000000f, 0.333333f, 0.000000f, 0.666667f, //
    0.166667f, 0.666667f, 0.333333f, 0.666667f, 0.500000f, 0.666667f, //
    0.666667f, 0.666667f, 0.833333f, 0.666667f, 1.000000f, 0.666667f, //
    0.000000f, 1.000000f, 0.166667f, 1.000000f, 0.333333f, 1.000000f, //
    0.500000f, 1.000000f, 0.666667f, 1.000000f, 0.833333f, 1.000000f, //
    1.000000f, 1.000000f};                                            //
  // Perform comparison
  ...
  for (size_t i = 0; i < expectedNormals.size(); ++i) {
    EXPECT_NEAR(static_cast<double>(sphere->normals[i]),
                static_cast<double>(expectedNormals[i]), 1e-6);
  }
  EXPECT_EQ(sphere->uvs.size(), expectedUVs.size());
  for (size_t i = 0; i < expectedUVs.size(); ++i) {
    EXPECT_NEAR(static_cast<double>(sphere->uvs[i]),
                static_cast<double>(expectedUVs[i]), 1e-6);
  }
}
...
TEST(TestVertexData, CreateTiledGround)
{
  ...
  EXPECT_THAT(tiledGround->positions,
              ::testing::ContainerEq(expectedPositions));
