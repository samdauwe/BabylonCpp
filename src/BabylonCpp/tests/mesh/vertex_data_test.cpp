...
TEST(TestVertexData, CreateSphere)
{
  ...
  Uint32Array expectedIndices{
    7,  1,  8,  8,  2,  9,  9,  3,  10, 10, 4,  11, 11, 5,  12, 12, 6,  13, 7,  8,  14, 14, 8,  15,
    8,  9,  15, 15, 9,  16, 9,  10, 16, 16, 10, 17, 10, 11, 17, 17, 11, 18, 11, 12, 18, 18, 12, 19,
    12, 13, 19, 19, 13, 20, 14, 15, 21, 15, 16, 22, 16, 17, 23, 17, 18, 24, 18, 19, 25, 19, 20, 26};
  Float32Array expectedPositions{
