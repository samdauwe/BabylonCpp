...
std::string Base64::btoa(const std::string& str)
{
  return Base64::encode(reinterpret_cast<const unsigned char*>(str.c_str()),
                        static_cast<unsigned int>(str.length()));
}

std::string Base64::atob(const std::string& str)
{
