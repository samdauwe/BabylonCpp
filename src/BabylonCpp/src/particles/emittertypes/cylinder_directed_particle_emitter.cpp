...
CylinderDirectedParticleEmitter::CylinderDirectedParticleEmitter(float iRadius, float iHeight,
                                                                 float iRadiusRange,
...
void CylinderDirectedParticleEmitter::startDirectionFunction(const Matrix& worldMatrix,
...
std::unique_ptr<IParticleEmitterType> CylinderDirectedParticleEmitter::clone() const
{
  auto newOne = std::make_unique<CylinderDirectedParticleEmitter>(radius, height, radiusRange,
...
void CylinderDirectedParticleEmitter::parse(const json& serializationObject, Scene* scene)
{
  CylinderParticleEmitter::parse(serializationObject, scene);
