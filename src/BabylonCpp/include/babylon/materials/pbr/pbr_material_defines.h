...
struct BABYLON_SHARED_EXPORT PBRMaterialDefines
  ...
  static constexpr unsigned int REFLECTIONMAP_SKYBOX_TRANSFORMED    = 52;
  static constexpr unsigned int REFLECTIONMAP_EXPLICIT              = 53;
  static constexpr unsigned int REFLECTIONMAP_EQUIRECTANGULAR       = 54;
  static constexpr unsigned int REFLECTIONMAP_EQUIRECTANGULAR_FIXED = 55;
  static constexpr unsigned int REFLECTIONMAP_MIRROREDEQUIRECTANGULAR_FIXED
    = 56;
  static constexpr unsigned int INVERTCUBICMAP                = 57;
  static constexpr unsigned int USESPHERICALFROMREFLECTIONMAP = 58;
  static constexpr unsigned int USESPHERICALINVERTEX          = 59;
  static constexpr unsigned int REFLECTIONMAP_OPPOSITEZ       = 60;
  static constexpr unsigned int LODINREFLECTIONALPHA          = 61;
  static constexpr unsigned int GAMMAREFLECTION               = 62;
  static constexpr unsigned int RGBDREFLECTION                = 63;
  static constexpr unsigned int RADIANCEOCCLUSION             = 64;
  static constexpr unsigned int HORIZONOCCLUSION              = 65;

  static constexpr unsigned int REFRACTION                   = 66;
  static constexpr unsigned int REFRACTIONMAP_3D             = 67;
  static constexpr unsigned int REFRACTIONMAP_OPPOSITEZ      = 68;
  static constexpr unsigned int LODINREFRACTIONALPHA         = 69;
  static constexpr unsigned int GAMMAREFRACTION              = 70;
  static constexpr unsigned int RGBDREFRACTION               = 71;
  static constexpr unsigned int LINKREFRACTIONTOTRANSPARENCY = 72;

  static constexpr unsigned int INSTANCES = 73;

  static constexpr unsigned int NONUNIFORMSCALING = 74;

  static constexpr unsigned int MORPHTARGETS         = 75;
  static constexpr unsigned int MORPHTARGETS_NORMAL  = 76;
  static constexpr unsigned int MORPHTARGETS_TANGENT = 77;

  static constexpr unsigned int IMAGEPROCESSING            = 78;
  static constexpr unsigned int VIGNETTE                   = 79;
  static constexpr unsigned int VIGNETTEBLENDMODEMULTIPLY  = 80;
  static constexpr unsigned int VIGNETTEBLENDMODEOPAQUE    = 81;
  static constexpr unsigned int TONEMAPPING                = 82;
  static constexpr unsigned int TONEMAPPING_ACES           = 83;
  static constexpr unsigned int CONTRAST                   = 84;
  static constexpr unsigned int COLORCURVES                = 85;
  static constexpr unsigned int COLORGRADING               = 86;
  static constexpr unsigned int COLORGRADING3D             = 87;
  static constexpr unsigned int SAMPLER3DGREENDEPTH        = 88;
  static constexpr unsigned int SAMPLER3DBGRMAP            = 89;
  static constexpr unsigned int IMAGEPROCESSINGPOSTPROCESS = 90;
  static constexpr unsigned int EXPOSURE                   = 91;

  static constexpr unsigned int USEPHYSICALLIGHTFALLOFF = 92;
  static constexpr unsigned int USEGLTFLIGHTFALLOFF     = 93;
  static constexpr unsigned int TWOSIDEDLIGHTING        = 94;
  static constexpr unsigned int SHADOWFLOAT             = 95;
  static constexpr unsigned int CLIPPLANE               = 96;
  static constexpr unsigned int CLIPPLANE2              = 97;
  static constexpr unsigned int CLIPPLANE3              = 98;
  static constexpr unsigned int CLIPPLANE4              = 99;
  static constexpr unsigned int POINTSIZE               = 100;
  static constexpr unsigned int FOG                     = 101;
  static constexpr unsigned int LOGARITHMICDEPTH        = 102;

  static constexpr unsigned int FORCENORMALFORWARD = 103;

  static constexpr unsigned int SPECULARAA = 104;

  static constexpr unsigned int UNLIT = 105;
