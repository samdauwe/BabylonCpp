#ifndef BABYLON_MATERIALS_TEXTURES_LOADERS_HDR_TEXTURE_LOADER_H
#define BABYLON_MATERIALS_TEXTURES_LOADERS_HDR_TEXTURE_LOADER_H
...
/**
 * @brief Implementation of the HDR Texture Loader.
 * @hidden
 */
struct BABYLON_SHARED_EXPORT _HDRTextureLoader : public IInternalTextureLoader {

  _HDRTextureLoader();
  ~_HDRTextureLoader() override; // = default
...
}; // end of struct _HDRTextureLoader

} // end of namespace BABYLON

#endif // end of BABYLON_MATERIALS_TEXTURES_LOADERS_HDR_TEXTURE_LOADER_H
