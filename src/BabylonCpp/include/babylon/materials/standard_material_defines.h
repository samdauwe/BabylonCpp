...
struct BABYLON_SHARED_EXPORT StandardMaterialDefines
  ...
  static constexpr unsigned int INVERTNORMALMAPX     = 53;
  static constexpr unsigned int INVERTNORMALMAPY     = 54;
  ...
  static constexpr unsigned int IMAGEPROCESSING            = 60;
  static constexpr unsigned int VIGNETTE                   = 61;
  static constexpr unsigned int VIGNETTEBLENDMODEMULTIPLY  = 62;
  ...
  static constexpr unsigned int IMAGEPROCESSINGPOSTPROCESS = 70;
  static constexpr unsigned int EXPOSURE                   = 71;
