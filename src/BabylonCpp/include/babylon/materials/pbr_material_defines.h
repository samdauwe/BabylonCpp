...
struct BABYLON_SHARED_EXPORT PBRMaterialDefines : public MaterialDefines {
  ...
  static constexpr unsigned int OVERLOADEDVALUES              = 50;
  static constexpr unsigned int OVERLOADEDSHADOWVALUES        = 51;
  ...
  static constexpr unsigned int LINKREFRACTIONTOTRANSPARENCY  = 55;
  static constexpr unsigned int REFRACTIONMAPINLINEARSPACE    = 56;
  static constexpr unsigned int LODBASEDMICROSFURACE          = 57;
  static constexpr unsigned int USEPHYSICALLIGHTFALLOFF       = 58;
  static constexpr unsigned int RADIANCEOVERALPHA             = 59;
  static constexpr unsigned int USEPMREMREFLECTION            = 60;
  static constexpr unsigned int USEPMREMREFRACTION            = 61;
  static constexpr unsigned int INVERTNORMALMAPX              = 62;
  static constexpr unsigned int INVERTNORMALMAPY              = 63;
  static constexpr unsigned int TWOSIDEDLIGHTING              = 64;
  static constexpr unsigned int SHADOWFULLFLOAT               = 65;
  static constexpr unsigned int METALLICWORKFLOW              = 66;
  static constexpr unsigned int METALLICMAP                   = 67;
  static constexpr unsigned int ROUGHNESSSTOREINMETALMAPALPHA = 68;
  static constexpr unsigned int ROUGHNESSSTOREINMETALMAPGREEN = 69;
  static constexpr unsigned int METALLNESSSTOREINMETALMAPBLUE = 70;
  static constexpr unsigned int AOSTOREINMETALMAPRED          = 71;
