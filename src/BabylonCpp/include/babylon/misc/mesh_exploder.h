...
/**
 * @brief Class used to explode meshes (ie. to have a center and move them away
 * from that center to better see the overall organization)
 */
...
public:
   ...
   * @param direction Number to multiply distance of each mesh's origin from
   * center. Use a negative number to implode, or zero to reset.
   */
