#ifndef BABYLON_MISC_HIGH_DYNAMIC_RANGE_CMG_BOUNDING_BOX_H
#define BABYLON_MISC_HIGH_DYNAMIC_RANGE_CMG_BOUNDING_BOX_H
...
#endif // end of BABYLON_MISC_HIGH_DYNAMIC_RANGE_CMG_BOUNDING_BOX_H
