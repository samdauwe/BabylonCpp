...
public:
  ...
  // clang-format off
  /**
   * @brief Creates a ribbon mesh. The ribbon is a parametric shape.  It has no predefined shape. Its final shape will depend on the input parameters
  ...
  // clang-format off
  /**
   * @brief Creates a line system mesh. A line system is a pool of many lines gathered in a single mesh
