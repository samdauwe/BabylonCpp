...
struct BABYLON_SHARED_EXPORT DiscBuilder {
   ...
   * * The parameter `tessellation` sets the number of polygon sides (positive integer, default 64).
   * So a tessellation valued to 3 will build a triangle, to 4 a square, etc
   * * You can create an unclosed polygon with the parameter `arc` (positive float, default 1),
   * valued between 0 and 1, what is the ratio of the circumference : 2 x PI x ratio
