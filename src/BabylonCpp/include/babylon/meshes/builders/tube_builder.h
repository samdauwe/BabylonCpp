#ifndef BABYLON_MESHES_BUILDERS_TUBE_BUILDER_H
#define BABYLON_MESHES_BUILDERS_TUBE_BUILDER_H
 ...
 */
struct BABYLON_SHARED_EXPORT TubeBuilder {
...
}; // end of struct TubeBuilder

} // end of namespace BABYLON

#endif // end of BABYLON_MESHES_BUILDERS_TUBE_BUILDER_H
