...
/**
 * @brief The options Interface for creating a Capsule Mesh.
 */
class BABYLON_SHARED_EXPORT ICreateCapsuleOptions {
...
public:
  ...
  std::optional<Vector3> orientation;
  ...
  std::optional<unsigned int> capSubdivisions;

  /** Overwrite for the top radius. */
  std::optional<float> radiusTop;

  /** Overwrite for the bottom radius. */
  std::optional<float> radiusBottom;

  /** Overwrite for the top capSubdivisions. */
  std::optional<unsigned int> topCapSubdivisions;
...
public:
  ...
  std::optional<Vector4> frontUVs;
  std::optional<Vector4> backUVs;
  std::optional<bool> dedupTopBottomIndices;
  std::optional<bool> updatable;
