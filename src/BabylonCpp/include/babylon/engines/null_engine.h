...
public:
  ...
  {
    std::unique_ptr<NullEngine> engine(
  ...
  void setIntArray(GL::IGLUniformLocation* uniform,
                   const Int32Array& array) override;
  void setIntArray2(GL::IGLUniformLocation* uniform,
                    const Int32Array& array) override;
  void setIntArray3(GL::IGLUniformLocation* uniform,
                    const Int32Array& array) override;
  void setIntArray4(GL::IGLUniformLocation* uniform,
                    const Int32Array& array) override;
  ...
  void setFloatArray4(GL::IGLUniformLocation* uniform,
                      const Float32Array& array) override;
  void setArray(GL::IGLUniformLocation* uniform,
                const Float32Array& array) override;
  void setArray2(GL::IGLUniformLocation* uniform,
                 const Float32Array& array) override;
  void setArray3(GL::IGLUniformLocation* uniform,
                 const Float32Array& array) override;
  void setArray4(GL::IGLUniformLocation* uniform,
                 const Float32Array& array) override;
  void setMatrices(GL::IGLUniformLocation* uniform,
                   const Float32Array& matrices) override;
  void setMatrix(GL::IGLUniformLocation* uniform,
                 const Matrix& matrix) override;
  void setMatrix3x3(GL::IGLUniformLocation* uniform,
                    const Float32Array& matrix) override;
  ...
  void setFloat3(GL::IGLUniformLocation* uniform, float x, float y,
                 float z) override;
  ...
  void setFloat4(GL::IGLUniformLocation* uniform, float x, float y, float z,
                 float w) override;
  void setColor3(GL::IGLUniformLocation* uniform,
  ...
  void setAlphaMode(unsigned int mode,
                    bool noDepthWriteChange = false) override;
  void bindBuffers(
  ...
  void drawElementsType(unsigned int fillMode, int indexStart,
                        int verticesCount, int instancesCount = 0) override;
  ...
  void updateDynamicTexture(const InternalTexturePtr& texture, ICanvas* canvas,
                            ...
                            unsigned int format
                            = Constants::TEXTUREFORMAT_RGBA) override;
