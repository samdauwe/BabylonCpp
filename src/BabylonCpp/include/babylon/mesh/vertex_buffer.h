...
public:
  ...
  static constexpr unsigned int UVKind                   = 3;
  static constexpr unsigned int UV2Kind                  = 4;
  static constexpr unsigned int UV3Kind                  = 5;
  static constexpr unsigned int UV4Kind                  = 6;
  static constexpr unsigned int UV5Kind                  = 7;
  static constexpr unsigned int UV6Kind                  = 8;
  static constexpr unsigned int ColorKind                = 9;
  static constexpr unsigned int MatricesIndicesKind      = 10;
  static constexpr unsigned int MatricesWeightsKind      = 11;
  static constexpr unsigned int MatricesIndicesExtraKind = 12;
  static constexpr unsigned int MatricesWeightsExtraKind = 13;
  static constexpr unsigned int World0Kind               = 14;
  static constexpr unsigned int World1Kind               = 15;
  static constexpr unsigned int World2Kind               = 16;
  static constexpr unsigned int World3Kind               = 17;
  static constexpr unsigned int CellInfoKind             = 18;
  static constexpr unsigned int OptionsKind              = 19;
