 ...
 */
class BABYLON_SHARED_EXPORT MotorEnabledJoint : public PhysicsJoint, public IMotorEnabledJoint {
...
public:
   ...
   */
  void setMotor(float force, float maxForce, unsigned int motorIndex = 0) override;
