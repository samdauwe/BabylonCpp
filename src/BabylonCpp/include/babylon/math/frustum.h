...
/**
 * @brief Reprasents a camera frustum.
 */
...
public:
   ...
   * @returns a new array of 6 Frustum planes computed by the given
   ...
   * @param transform transformation matrix to be applied to the resulting
   * frustum plane
