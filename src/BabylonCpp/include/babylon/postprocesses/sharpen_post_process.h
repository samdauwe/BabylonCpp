#ifndef BABYLON_POSTPROCESSES_SHARPEN_POST_PROCESS_H
#define BABYLON_POSTPROCESSES_SHARPEN_POST_PROCESS_H
...
public:
   ...
   * @brief Hidden
   */
  static SharpenPostProcessPtr _Parse(const json& parsedPostProcess, const CameraPtr& targetCamera,
...
public:
  /**
   * How much of the original color should be applied. Setting this to 0 will display edge
   * detection. (default: 1)
   */
  float colorAmount;
  /**
...
#endif // end of BABYLON_POSTPROCESSES_SHARPEN_POST_PROCESS_H
