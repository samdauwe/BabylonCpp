#ifndef BABYLON_POSTPROCESSES_DEPTH_OF_FIELD_MERGE_POST_PROCESS_OPTIONS_H
#define BABYLON_POSTPROCESSES_DEPTH_OF_FIELD_MERGE_POST_PROCESS_OPTIONS_H
...
#endif // end of
       // BABYLON_POSTPROCESSES_DEPTH_OF_FIELD_MERGE_POST_PROCESS_OPTIONS_H
