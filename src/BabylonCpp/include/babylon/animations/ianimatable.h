...
using AnimationPropertiesOverridePtr = std::shared_ptr<AnimationPropertiesOverride>;
...
public:
  ...
  [[nodiscard]] virtual bool markTargetAsDirty() const;
  ...
  virtual AnimationValue getProperty(const std::vector<std::string>& targetPropertyPath);
  virtual void setProperty(const std::vector<std::string>& targetPropertyPath,
                           const AnimationValue& value);

  static AnimationValue getProperty(const std::string& key, const Color3& color);
  static AnimationValue getProperty(const std::string& key, const Color4& color);
  static AnimationValue getProperty(const std::string& key, const Vector2& vector);
  static AnimationValue getProperty(const std::string& key, const Vector3& vector);
  static AnimationValue getProperty(const std::string& key, const Quaternion& quaternion);
  ...
  static void setProperty(const std::string& key, Quaternion& quaternion, float value);
...
protected:
  ...
  virtual void set_animationPropertiesOverride(const AnimationPropertiesOverridePtr& value);
...
public:
   ...
   */
  Property<IAnimatable, AnimationPropertiesOverridePtr> animationPropertiesOverride;
