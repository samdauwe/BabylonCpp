#ifndef BABYLON_LOADING_PLUGINS_GLTF_BINARY_READER_H
#define BABYLON_LOADING_PLUGINS_GLTF_BINARY_READER_H
...
#endif // end of BABYLON_LOADING_PLUGINS_GLTF_BINARY_READER_H
