...
protected:
  ...
  /**
   * @brief Gets the shader used to draw the lines.
   */
  ShaderMaterialPtr& get_lineShader();

  /**
   * @brief Sets the shader used to draw the lines.
   */
  void set_lineShader(const ShaderMaterialPtr& shader);
...
public:
   ...
   */
  Property<EdgesRenderer, ShaderMaterialPtr> lineShader;
