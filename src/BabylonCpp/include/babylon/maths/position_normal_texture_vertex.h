#ifndef BABYLON_MATHS_POSITION_NORMAL_TEXTURE_VERTEX_H
#define BABYLON_MATHS_POSITION_NORMAL_TEXTURE_VERTEX_H
...
#endif // end of BABYLON_MATHS_POSITION_NORMAL_TEXTURE_VERTEX_H
