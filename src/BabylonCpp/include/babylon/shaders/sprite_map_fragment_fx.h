#ifndef BABYLON_SHADERS_SPRITE_MAP_FRAGMENT_FX_H
#define BABYLON_SHADERS_SPRITE_MAP_FRAGMENT_FX_H

namespace BABYLON {

extern const char* spriteMapPixelShader;

const char* spriteMapPixelShader
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SPRITE_MAP_FRAGMENT_FX_H
