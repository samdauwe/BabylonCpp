#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_BAYER_DITHER_FUNCTIONS_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_BAYER_DITHER_FUNCTIONS_FX_H

namespace BABYLON {

extern const char* bayerDitherFunctions;

const char* bayerDitherFunctions
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_BAYER_DITHER_FUNCTIONS_FX_H
