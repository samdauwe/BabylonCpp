#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_FINAL_LIT_COMPONENTS_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_FINAL_LIT_COMPONENTS_FX_H

namespace BABYLON {

extern const char* pbrBlockFinalLitComponents;

const char* pbrBlockFinalLitComponents
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_FINAL_LIT_COMPONENTS_FX_H
