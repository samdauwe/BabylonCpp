#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_CLEARCOAT_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_CLEARCOAT_FX_H

namespace BABYLON {

extern const char* pbrBlockClearcoat;

const char* pbrBlockClearcoat
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_CLEARCOAT_FX_H
