#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_IMPORTANCE_SAMPLING_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_IMPORTANCE_SAMPLING_FX_H

namespace BABYLON {

extern const char* importanceSampling;

const char* importanceSampling
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_IMPORTANCE_SAMPLING_FX_H
