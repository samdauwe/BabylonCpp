#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_SUB_SURFACE_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_SUB_SURFACE_FX_H

namespace BABYLON {

extern const char* pbrBlockSubSurface;

const char* pbrBlockSubSurface
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_SUB_SURFACE_FX_H
