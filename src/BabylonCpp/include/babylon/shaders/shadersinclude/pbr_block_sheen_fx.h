#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_SHEEN_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_SHEEN_FX_H

namespace BABYLON {

extern const char* pbrBlockSheen;

const char* pbrBlockSheen
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_SHEEN_FX_H
