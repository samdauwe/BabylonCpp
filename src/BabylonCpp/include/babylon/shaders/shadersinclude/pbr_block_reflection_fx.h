#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_REFLECTION_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_REFLECTION_FX_H

namespace BABYLON {

extern const char* pbrBlockReflection;

const char* pbrBlockReflection
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_REFLECTION_FX_H
