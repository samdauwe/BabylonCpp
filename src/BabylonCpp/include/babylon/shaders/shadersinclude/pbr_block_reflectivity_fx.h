#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_REFLECTIVITY_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_REFLECTIVITY_FX_H

namespace BABYLON {

extern const char* pbrBlockReflectivity;

const char* pbrBlockReflectivity
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_REFLECTIVITY_FX_H
