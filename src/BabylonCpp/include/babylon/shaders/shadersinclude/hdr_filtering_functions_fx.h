#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_HDR_FILTERING_FUNCTIONS_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_HDR_FILTERING_FUNCTIONS_FX_H

namespace BABYLON {

extern const char* hdrFilteringFunctions;

const char* hdrFilteringFunctions
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_HDR_FILTERING_FUNCTIONS_FX_H
