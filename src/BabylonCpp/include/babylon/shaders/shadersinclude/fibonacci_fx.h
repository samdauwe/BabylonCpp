#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_FIBONACCI_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_FIBONACCI_FX_H

namespace BABYLON {

extern const char* fibonacci;
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_FIBONACCI_FX_H
