#ifndef BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_ALPHA_FRESNEL_FX_H
#define BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_ALPHA_FRESNEL_FX_H

namespace BABYLON {

extern const char* pbrBlockAlphaFresnel;

const char* pbrBlockAlphaFresnel
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SHADERS_INCLUDE_PBR_BLOCK_ALPHA_FRESNEL_FX_H
