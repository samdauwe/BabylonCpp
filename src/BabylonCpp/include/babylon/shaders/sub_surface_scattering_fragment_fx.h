#ifndef BABYLON_SHADERS_SUB_SURFACE_SCATTERING_FRAGMENT_FX_H
#define BABYLON_SHADERS_SUB_SURFACE_SCATTERING_FRAGMENT_FX_H

namespace BABYLON {

extern const char* subSurfaceScatteringPixelShader;

const char* subSurfaceScatteringPixelShader
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SUB_SURFACE_SCATTERING_FRAGMENT_FX_H
