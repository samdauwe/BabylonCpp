#ifndef BABYLON_SHADERS_SCREEN_SPACE_CURVATURE_FRAGMENT_FX_H
#define BABYLON_SHADERS_SCREEN_SPACE_CURVATURE_FRAGMENT_FX_H

namespace BABYLON {

extern const char* screenSpaceCurvaturePixelShader;

const char* screenSpaceCurvaturePixelShader
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SCREEN_SPACE_CURVATURE_FRAGMENT_FX_H
