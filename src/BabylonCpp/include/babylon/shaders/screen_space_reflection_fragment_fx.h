#ifndef BABYLON_SHADERS_SCREEN_SPACE_REFLECTION_FRAGMENT_FX_H
#define BABYLON_SHADERS_SCREEN_SPACE_REFLECTION_FRAGMENT_FX_H

namespace BABYLON {

extern const char* screenSpaceReflectionPixelShader;

const char* screenSpaceReflectionPixelShader
  = R"ShaderCode(
...
#endif // end of BABYLON_SHADERS_SCREEN_SPACE_REFLECTION_FRAGMENT_FX_H
