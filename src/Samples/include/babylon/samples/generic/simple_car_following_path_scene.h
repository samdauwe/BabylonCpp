#ifndef BABYLON_SAMPLES_GENERIC_SIMPLE_CAR_FOLLOWING_PATH_SCENE_H
#define BABYLON_SAMPLES_GENERIC_SIMPLE_CAR_FOLLOWING_PATH_SCENE_H
...
#endif // end of BABYLON_SAMPLES_GENERIC_SIMPLE_CAR_FOLLOWING_PATH_SCENE_H
