#ifndef BABYLON_SAMPLES_SPECIAL_FX_FIREWORKS_WITH_SHADER_CODE_SCENE_H
...
public:
  ...
  ~FireworksWithShaderCodeScene() override;
...
#endif // end of
       // BABYLON_SAMPLES_SPECIAL_FX_FIREWORKS_WITH_SHADER_CODE_SCENE_H
