#ifndef BABYLON_SAMPLES_MATERIALS_SHADER_MATERIAL_CHAINS_AND_GEARS_SCENE_H
...
public:
  ...
  ~ShaderMaterialChainsAndGearsScene() override;
...
#endif // end of
       // BABYLON_SAMPLES_MATERIALS_SHADER_MATERIAL_CHAINS_AND_GEARS_SCENE_H
