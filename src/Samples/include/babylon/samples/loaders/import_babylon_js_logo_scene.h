#ifndef BABYLON_SAMPLES_LOADERS_IMPORT_BABYLON_JS_LOGO_SCENE_H
#define BABYLON_SAMPLES_LOADERS_IMPORT_BABYLON_JS_LOGO_SCENE_H
...
#endif // end of BABYLON_SAMPLES_LOADERS_IMPORT_BABYLON_JS_LOGO_SCENE_H
