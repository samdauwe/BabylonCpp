...
LavaMaterialScene::LavaMaterialScene(ICanvas* iCanvas)
    : IRenderableScene(iCanvas)
{
}

LavaMaterialScene::~LavaMaterialScene()
{
}

const char* LavaMaterialScene::getName()
{
  return "Lava Material Scene";
}

void LavaMaterialScene::initializeScene(ICanvas* canvas, Scene* scene)
{
  ...
  lavaMaterial->diffuseTexture
    = Texture::New("textures/lava/lavatile.jpg", scene);
