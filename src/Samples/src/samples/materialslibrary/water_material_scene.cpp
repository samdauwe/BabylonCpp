...
struct WaterMaterialScene : public IRenderableScene {
  ...
  WaterMaterialScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
  {
  }

  ~WaterMaterialScene() override = default;
  ...
  void initializeScene(ICanvas* canvas, Scene* scene) override
  {
    // Camera
    auto camera
      = ArcRotateCamera::New("Camera", 3.f * Math::PI_2, Math::PI_4, 100.f, Vector3::Zero(), scene);
...
BABYLON_REGISTER_SAMPLE("Materials Library", WaterMaterialScene)
