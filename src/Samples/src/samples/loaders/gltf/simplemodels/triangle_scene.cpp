...
TriangleScene::TriangleScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
{
...
const char* TriangleScene::getName()
{
  return "Triangle Scene (glTF)";
}

void TriangleScene::initializeScene(ICanvas* /*canvas*/, Scene* scene)
{
