...
CamerasGLTFScene::CamerasGLTFScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
{
  GLTF2::GLTFFileLoader::RegisterAsSceneLoaderPlugin();
}

CamerasGLTFScene::~CamerasGLTFScene()
{
}

const char* CamerasGLTFScene::getName()
{
  return "Cameras Scene (glTF)";
}

void CamerasGLTFScene::initializeScene(ICanvas* /*canvas*/, Scene* scene)
{
