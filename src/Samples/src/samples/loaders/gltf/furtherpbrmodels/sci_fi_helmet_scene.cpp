...
SciFiHelmetScene::SciFiHelmetScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
{
  GLTF2::GLTFFileLoader::RegisterAsSceneLoaderPlugin();
}

SciFiHelmetScene::~SciFiHelmetScene()
{
}

const char* SciFiHelmetScene::getName()
{
  return "Sci Fi Helmet Scene (glTF)";
}

void SciFiHelmetScene::initializeScene(ICanvas* /*canvas*/, Scene* scene)
{
