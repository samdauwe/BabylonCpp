...
EasingFunctionsScene::EasingFunctionsScene(ICanvas* iCanvas)
    : IRenderableScene(iCanvas)
{
}

EasingFunctionsScene::~EasingFunctionsScene()
{
}

const char* EasingFunctionsScene::getName()
{
  return "Easing Functions Scene";
}

void EasingFunctionsScene::initializeScene(ICanvas* canvas, Scene* scene)
{
  // Create a light
  ...
  Animation::CreateAndStartAnimation(
    "anim", torus0, "position", 30, 120, AnimationValue(torus0->position()),
