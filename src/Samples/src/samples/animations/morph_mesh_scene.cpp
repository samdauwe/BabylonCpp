...
MorphMeshScene::MorphMeshScene(ICanvas* iCanvas)
    : IRenderableScene(iCanvas), _testMorphTarget{nullptr}, _currentAnim{0}
{
}

MorphMeshScene::~MorphMeshScene()
{
}

const char* MorphMeshScene::getName()
{
  return "Morph Mesh Scene";
}

void MorphMeshScene::initializeScene(ICanvas* canvas, Scene* scene)
{
  // Camera
