...
LorenzAttractorScene::LorenzAttractorScene(ICanvas* iCanvas)
    : IRenderableScene(iCanvas)
{
}

LorenzAttractorScene::~LorenzAttractorScene()
{
}

const char* LorenzAttractorScene::getName()
{
  return "Lorenz Attractor Scene";
}

void LorenzAttractorScene::initializeScene(ICanvas* canvas, Scene* scene)
{
  // Create a camera
  auto camera
