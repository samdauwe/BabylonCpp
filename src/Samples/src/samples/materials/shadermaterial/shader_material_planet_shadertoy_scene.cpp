...
ShaderMaterialPlanetShadertoyScene::ShaderMaterialPlanetShadertoyScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialPlanetShadertoyScene::getName()
{
  return "Shader Material Planet Shadertoy Scene";
}

void ShaderMaterialPlanetShadertoyScene::initializeScene(ICanvas* canvas,
                                                         Scene* scene)
{
