...
ShaderMaterialKIFSScene::ShaderMaterialKIFSScene(ICanvas* iCanvas)
...
ShaderMaterialKIFSScene::~ShaderMaterialKIFSScene()
{
}

const char* ShaderMaterialKIFSScene::getName()
{
  return "Shader Material KIFS Scene";
}

void ShaderMaterialKIFSScene::initializeScene(ICanvas* canvas, Scene* scene)
{
