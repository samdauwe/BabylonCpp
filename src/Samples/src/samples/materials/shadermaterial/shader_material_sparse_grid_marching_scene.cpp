...
ShaderMaterialSparseGridMarchingScene::ShaderMaterialSparseGridMarchingScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialSparseGridMarchingScene::getName()
{
  return "Shader Material Sparse Grid Marching Scene";
}

void ShaderMaterialSparseGridMarchingScene::initializeScene(ICanvas* canvas,
                                                            Scene* scene)
{
