...
ShaderMaterialCarvedTreesScene::ShaderMaterialCarvedTreesScene(ICanvas* iCanvas)
...
ShaderMaterialCarvedTreesScene::~ShaderMaterialCarvedTreesScene()
{
}

const char* ShaderMaterialCarvedTreesScene::getName()
{
  return "Shader Material Carved Trees Scene";
}

void ShaderMaterialCarvedTreesScene::initializeScene(ICanvas* canvas,
                                                     Scene* scene)
{
