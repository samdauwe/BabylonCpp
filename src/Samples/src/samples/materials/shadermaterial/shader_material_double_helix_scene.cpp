...
ShaderMaterialDoubleHelixScene::ShaderMaterialDoubleHelixScene(ICanvas* iCanvas)
...
ShaderMaterialDoubleHelixScene::~ShaderMaterialDoubleHelixScene()
{
}

const char* ShaderMaterialDoubleHelixScene::getName()
{
  return "Shader Material Double Helix Scene";
}

void ShaderMaterialDoubleHelixScene::initializeScene(ICanvas* canvas,
                                                     Scene* scene)
{
