...
ShaderMaterialServerRoomScene::ShaderMaterialServerRoomScene(ICanvas* iCanvas)
...
ShaderMaterialServerRoomScene::~ShaderMaterialServerRoomScene()
{
}

const char* ShaderMaterialServerRoomScene::getName()
{
  return "Shader Material Server Room Scene";
}

void ShaderMaterialServerRoomScene::initializeScene(ICanvas* canvas,
                                                    Scene* scene)
{
