...
ShaderMaterialMorningCityScene::ShaderMaterialMorningCityScene(ICanvas* iCanvas)
...
ShaderMaterialMorningCityScene::~ShaderMaterialMorningCityScene()
{
}

const char* ShaderMaterialMorningCityScene::getName()
{
  return "Shader Material Morning City Scene";
}

void ShaderMaterialMorningCityScene::initializeScene(ICanvas* canvas,
                                                     Scene* scene)
{
