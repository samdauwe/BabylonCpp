...
ShaderMaterialGeneratorsScene::ShaderMaterialGeneratorsScene(ICanvas* iCanvas)
...
ShaderMaterialGeneratorsScene::~ShaderMaterialGeneratorsScene()
{
}

const char* ShaderMaterialGeneratorsScene::getName()
{
  return "Shader Material Generators Scene";
}

void ShaderMaterialGeneratorsScene::initializeScene(ICanvas* canvas,
                                                    Scene* scene)
{
