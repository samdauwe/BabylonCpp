...
ShaderMaterialPegasusGalaxyScene::ShaderMaterialPegasusGalaxyScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialPegasusGalaxyScene::getName()
{
  return "Shader Material Pegasus Galaxy Scene";
}

void ShaderMaterialPegasusGalaxyScene::initializeScene(ICanvas* canvas,
                                                       Scene* scene)
{
