...
ShaderMaterialVoronoianWaterwayScene::ShaderMaterialVoronoianWaterwayScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialVoronoianWaterwayScene::getName()
{
  return "Shader Material Voronoian Waterway Scene";
}

void ShaderMaterialVoronoianWaterwayScene::initializeScene(ICanvas* canvas,
                                                           Scene* scene)
{
