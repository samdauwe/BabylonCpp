...
ShaderMaterialSimplicityScene::ShaderMaterialSimplicityScene(ICanvas* iCanvas)
...
ShaderMaterialSimplicityScene::~ShaderMaterialSimplicityScene()
{
}

const char* ShaderMaterialSimplicityScene::getName()
{
  return "Shader Material Simplicity Scene";
}

void ShaderMaterialSimplicityScene::initializeScene(ICanvas* canvas,
                                                    Scene* scene)
{
