...
ShaderMaterialStarNestScene::ShaderMaterialStarNestScene(ICanvas* iCanvas)
...
ShaderMaterialStarNestScene::~ShaderMaterialStarNestScene()
{
}

const char* ShaderMaterialStarNestScene::getName()
{
  return "Shader Material Star Nest Scene";
}

void ShaderMaterialStarNestScene::initializeScene(ICanvas* canvas, Scene* scene)
{
