...
ShaderMaterialPhysicallyBasedSDFScene::ShaderMaterialPhysicallyBasedSDFScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialPhysicallyBasedSDFScene::getName()
{
  return "Shader Material Physically-based SDF Scene";
}

void ShaderMaterialPhysicallyBasedSDFScene::initializeScene(ICanvas* canvas,
                                                            Scene* scene)
{
