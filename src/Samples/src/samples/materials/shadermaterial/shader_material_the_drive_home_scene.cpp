...
ShaderMaterialTheDriveHomeScene::ShaderMaterialTheDriveHomeScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialTheDriveHomeScene::getName()
{
  return "Shader Material The Drive Home Scene";
}

void ShaderMaterialTheDriveHomeScene::initializeScene(ICanvas* canvas,
                                                      Scene* scene)
{
