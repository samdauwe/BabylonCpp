...
ShaderMaterialXyptonjtrozScene::ShaderMaterialXyptonjtrozScene(ICanvas* iCanvas)
...
ShaderMaterialXyptonjtrozScene::~ShaderMaterialXyptonjtrozScene()
{
}

const char* ShaderMaterialXyptonjtrozScene::getName()
{
