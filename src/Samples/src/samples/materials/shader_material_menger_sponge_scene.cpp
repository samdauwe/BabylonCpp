...
ShaderMaterialMengerSpongeScene::ShaderMaterialMengerSpongeScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialMengerSpongeScene::getName()
{
  return "Shader Material Menger Sponge Scene";
}

void ShaderMaterialMengerSpongeScene::initializeScene(ICanvas* canvas,
                                                      Scene* scene)
{
