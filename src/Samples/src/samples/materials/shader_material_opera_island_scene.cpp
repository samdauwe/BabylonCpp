...
ShaderMaterialOperaIslandScene::ShaderMaterialOperaIslandScene(ICanvas* iCanvas)
...
ShaderMaterialOperaIslandScene::~ShaderMaterialOperaIslandScene()
{
}

const char* ShaderMaterialOperaIslandScene::getName()
{
  return "Shader Material Opera Island Scene";
}

void ShaderMaterialOperaIslandScene::initializeScene(ICanvas* canvas,
                                                     Scene* scene)
{
