...
struct FresnelParametersTorusKnotScene : public IRenderableScene {
  ...
  FresnelParametersTorusKnotScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
  {
  }

  ~FresnelParametersTorusKnotScene() override = default;
  ...
  void initializeScene(ICanvas* canvas, Scene* scene) override
  {
    ...
    auto torusKnot   = Mesh::CreateTorusKnot("knot", 2.f, 0.5f, 128, 64, 2.f, 3.f, scene);
...
BABYLON_REGISTER_SAMPLE("Materials", FresnelParametersTorusKnotScene)
