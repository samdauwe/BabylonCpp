...
ShaderMaterialTheRoadToHellScene::ShaderMaterialTheRoadToHellScene(
  ICanvas* iCanvas)
...
const char* ShaderMaterialTheRoadToHellScene::getName()
{
  return "Shader Material The Road To Hell Scene";
}

void ShaderMaterialTheRoadToHellScene::initializeScene(ICanvas* canvas,
                                                       Scene* scene)
{
