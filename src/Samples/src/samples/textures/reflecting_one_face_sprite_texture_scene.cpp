...
ReflectingOneFaceSpriteTextureScene::ReflectingOneFaceSpriteTextureScene(
  ICanvas* iCanvas)
...
const char* ReflectingOneFaceSpriteTextureScene::getName()
{
  return "Reflecting One Face Sprite Texture Scene";
}

void ReflectingOneFaceSpriteTextureScene::initializeScene(ICanvas* canvas,
                                                          Scene* scene)
{
  ...
  faceUV_V_reflect[1]
    = Vector4(Utop_right, Vbottom_left, Ubottom_left, Vtop_right);
  ...
  faceUV_H_reflect[1]
    = Vector4(Ubottom_left, Vtop_right, Utop_right, Vbottom_left);
  ...
  faceUV_VH_reflect[1]
    = Vector4(Utop_right, Vtop_right, Ubottom_left, Vbottom_left);

  BoxOptions options_VH_reflect;
  options_VH_reflect.faceUV = faceUV_VH_reflect;
  auto box_VH_reflect
    = MeshBuilder::CreateBox("box", options_VH_reflect, scene);
