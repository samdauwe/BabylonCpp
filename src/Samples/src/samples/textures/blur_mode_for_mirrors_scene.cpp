...
public:
  BlurModeForMirrorsScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
  {
  }

  ~BlurModeForMirrorsScene() override = default;

  const char* getName() override
  {
    return "Blur Mode For Mirrors Scene";
  }
...
BABYLON_REGISTER_SAMPLE("Textures", BlurModeForMirrorsScene)
