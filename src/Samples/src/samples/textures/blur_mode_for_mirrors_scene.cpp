...
BlurModeForMirrorsScene::BlurModeForMirrorsScene(ICanvas* iCanvas)
    : IRenderableScene(iCanvas)
{
}

BlurModeForMirrorsScene::~BlurModeForMirrorsScene()
{
}

const char* BlurModeForMirrorsScene::getName()
{
