...
/**
 * @brief Realtime refraction scene. This example demonstrates how to use reflection probes to
 * simulate realtime refraction.
...
public:
  ...
  ~RealtimeRefractionScene() override = default;
...
BABYLON_REGISTER_SAMPLE("Special FX", RealtimeRefractionScene)
