...
DawnBringerScene::DawnBringerScene(ICanvas* iCanvas)
...
DawnBringerScene::~DawnBringerScene()
{
}

const char* DawnBringerScene::getName()
{
  return "Dawn Bringer Scene";
}

void DawnBringerScene::initializeScene(ICanvas* canvas, Scene* scene)
{
  // Adding a light
  ...
  _postEffect = PostProcess::New("dawnBringerEffect", "dawnBringerEffect",
                                 {"time", "screenSize"},
