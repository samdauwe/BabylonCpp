...
HeatWaveScene::HeatWaveScene(ICanvas* iCanvas)
...
HeatWaveScene::~HeatWaveScene()
{
}

const char* HeatWaveScene::getName()
{
  return "Heat Wave Scene";
}

void HeatWaveScene::initializeScene(ICanvas* canvas, Scene* scene)
{
  // Adding a light
  ...
  _postEffect
    = PostProcess::New("thanosEffect", "thanosEffect", {"time", "screenSize"},
