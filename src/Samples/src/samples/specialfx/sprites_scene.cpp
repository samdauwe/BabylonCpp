...
public:
  SpritesScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
  {
  }

  ~SpritesScene() override = default;
  ...
  void initializeScene(ICanvas* canvas, Scene* scene) override
  {
    ...
    auto camera = ArcRotateCamera::New("Camera", 1.f, 0.8f, 8.f, Vector3::Zero(), scene);
    ...
    auto spriteManagerTrees
      = SpriteManager::New("treesManager", "textures/palm.png", 2000, 1024, scene);
    ...
    scene->onPointerObservable.add(_pointerInput, static_cast<int>(PointerEventTypes::POINTERDOWN));
  }
...
BABYLON_REGISTER_SAMPLE("Special FX", SpritesScene)
