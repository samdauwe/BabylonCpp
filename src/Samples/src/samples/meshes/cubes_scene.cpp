...
CubesScene::CubesScene(ICanvas* iCanvas) : IRenderableScene(iCanvas), _t{0.f}
{
}
...
const char* CubesScene::getName()
{
  return "Cubes Scene";
}

void CubesScene::initializeScene(ICanvas* canvas, Scene* scene)
{
