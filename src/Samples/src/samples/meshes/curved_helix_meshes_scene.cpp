...
public:
  CurvedHelixMeshesScene(ICanvas* iCanvas) : IRenderableScene(iCanvas)
  {
  }

  ~CurvedHelixMeshesScene() override = default;
  ...
  void initializeScene(ICanvas* canvas, Scene* scene) override
  {
    ...
    auto extruded = Mesh::ExtrudeShape("extruded", shape, path, 0.5f, Math::PI / 5.f, 0, scene);
