...
CrowdSimulationScene01::CrowdSimulationScene01(ICanvas* iCanvas)
    : IRenderableScene(iCanvas), _crowdSimulation{nullptr}
{
}

CrowdSimulationScene01::~CrowdSimulationScene01()
{
}

const char* CrowdSimulationScene01::getName()
{
  return "Crowd Simulation Scene 01";
}

void CrowdSimulationScene01::initializeScene(ICanvas* canvas, Scene* scene)
{
...
void CrowdSimulationScene01::setupScenario(Scene* scene)
{
  // Create agent meshes
