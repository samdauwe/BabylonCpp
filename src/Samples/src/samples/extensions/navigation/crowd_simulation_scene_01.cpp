...
public:
  CrowdSimulationScene01(ICanvas* iCanvas) : IRenderableScene(iCanvas), _crowdSimulation{nullptr}
  {
  }

  ~CrowdSimulationScene01() override = default;
...
BABYLON_REGISTER_SAMPLE("Extensions", CrowdSimulationScene01)
