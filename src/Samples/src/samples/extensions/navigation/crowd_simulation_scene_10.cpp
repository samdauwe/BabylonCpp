...
CrowdSimulationScene10::CrowdSimulationScene10(ICanvas* iCanvas)
    : IRenderableScene(iCanvas), _crowdSimulation{nullptr}
{
}

CrowdSimulationScene10::~CrowdSimulationScene10()
{
}

const char* CrowdSimulationScene10::getName()
{
  return "Crowd Simulation Scene 10";
}

void CrowdSimulationScene10::initializeScene(ICanvas* canvas, Scene* scene)
{
...
void CrowdSimulationScene10::setupScenario(Scene* scene)
{
  // Create agent meshes
