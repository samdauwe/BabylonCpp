...
CrowdSimulationScene03::CrowdSimulationScene03(ICanvas* iCanvas)
    : IRenderableScene(iCanvas), _crowdSimulation{nullptr}
{
}

CrowdSimulationScene03::~CrowdSimulationScene03()
{
}

const char* CrowdSimulationScene03::getName()
{
  return "Crowd Simulation Scene 03";
}

void CrowdSimulationScene03::initializeScene(ICanvas* canvas, Scene* scene)
{
...
void CrowdSimulationScene03::setupScenario(Scene* scene)
{
  // Create agent meshes
