...
CrowdSimulationScene07::CrowdSimulationScene07(ICanvas* iCanvas)
    : IRenderableScene(iCanvas), _crowdSimulation{nullptr}
{
}

CrowdSimulationScene07::~CrowdSimulationScene07()
{
}

const char* CrowdSimulationScene07::getName()
{
  return "Crowd Simulation Scene 07";
}

void CrowdSimulationScene07::initializeScene(ICanvas* canvas, Scene* scene)
{
...
void CrowdSimulationScene07::setupScenario(Scene* scene)
{
  // Create agent meshes
