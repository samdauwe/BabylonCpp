...
CrowdSimulationScene06::CrowdSimulationScene06(ICanvas* iCanvas)
    : IRenderableScene(iCanvas), _crowdSimulation{nullptr}
{
}

CrowdSimulationScene06::~CrowdSimulationScene06()
{
}

const char* CrowdSimulationScene06::getName()
{
  return "Crowd Simulation Scene 06";
}

void CrowdSimulationScene06::initializeScene(ICanvas* canvas, Scene* scene)
{
...
void CrowdSimulationScene06::setupScenario(Scene* scene)
{
  // Create agent meshes
