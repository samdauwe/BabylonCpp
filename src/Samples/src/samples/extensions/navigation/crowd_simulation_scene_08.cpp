...
CrowdSimulationScene08::CrowdSimulationScene08(ICanvas* iCanvas)
    : IRenderableScene(iCanvas), _crowdSimulation{nullptr}
{
}

CrowdSimulationScene08::~CrowdSimulationScene08()
{
}

const char* CrowdSimulationScene08::getName()
{
  return "Crowd Simulation Scene 08";
}

void CrowdSimulationScene08::initializeScene(ICanvas* canvas, Scene* scene)
{
...
void CrowdSimulationScene08::setupScenario(Scene* scene)
{
  // Create agent meshes
  ...
  // Set high precision
  _crowdSimulation->setPrecision(3);
