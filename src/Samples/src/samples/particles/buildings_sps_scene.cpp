...
/**
 * @brief Buldings SPS Scene. A lot of buildings with SPS. Example demonstrating how to use solid
 * particle system to create a city.
...
public:
  ...
  ~BuildingsSpsScene() override = default;
...
BABYLON_REGISTER_SAMPLE("Particles", BuildingsSpsScene)
